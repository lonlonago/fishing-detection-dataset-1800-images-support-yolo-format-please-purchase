# Fishing detection dataset 1800 images support yolo format please purchase.

# Body

Fishing detection dataset, 1800 images, support yolo format， or change
Ideal for target detection model training, research, project development.
